...
public class ManyToManyTest {
    ...
    void test1() {
        ...
        food.setPrice(15000);
        food.getUserList().add(user); // 1대 다 관계에서 하던 것처럼 List에 add
    ...
    void test4() {
        ...
        // 주문한 음식들 보기 > 아보카도, 고구마 나와야 함, 안 나와!
        ...
        // 위의 로직을 보면 User에 Food의 정보를 넣는 부분이 없다!
    }
    ...
    @Test
    @DisplayName("N대M 조회 : User 기준 food 정보 조회") // 양방향이라 조회 가능
    void test7() {
